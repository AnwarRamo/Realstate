...
const PropertyList = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-4xl mb-4 ml-[380px] text-[#1F4B43] font-bold">Properties For Rent</h1>
          ...
          <hr className="bg-[#E7C873] h-1 w-20 mb-4" />
            ...
            {visibleFlats < flatProperties.length && (
              <button
                ...
                className="border mt-[30px] border-gray-800 text-gray-800 px-4 py-2 rounded hover:bg-[#E7C873] hover:text-white"
              >
                Show More Flats
              </button>
            )}
          ...
          <hr className="bg-[#E7C873] h-1 w-20 mb-4" />
            ...
            {visibleVillas < villaProperties.length && (
              <button
                ...
                className="mt-4 mt-[30px] bg-[#1F4B43] text-white py-2 px-4 rounded"
              >
                Show More Villas
              </button>
            )}
